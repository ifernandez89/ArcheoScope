#!/usr/bin/env python3
"""
Limpiar tabla y migrar con bulk insert
"""
...
async def migrate():
    ...
    # Limpiar tabla
    print("Limpiando tabla archaeological_sites...")
    ...
    print(f"\nCOMPLETADO!")
    print(f"Total en base de datos: {count:,} sitios")
