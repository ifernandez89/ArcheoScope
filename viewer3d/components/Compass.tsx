...
export default function Compass({ solarAzimuth }: CompassProps) {
  const [rotation, setRotation] = useState(0)

  useEffect(() => {
    setRotation(-solarAzimuth)
  }, [solarAzimuth])
  ...
  return (
    ...
    >
      ...
      {/* Aguja */}
      <div style={{ position: 'absolute', width: '100%', height: '100%', transition: 'transform 0.5s ease-out', transform: `rotate(${rotation}deg)` }}>
