    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <strong>Archeoscope</strong> toma inspiración de diversas culturas
            antiguas, teorías arqueológicas y estudios sobre la conciencia.
          </p>
          ...
          >
            El concepto de <strong>armonía cósmica</strong> está influenciado
            por el trabajo del astrónomo <strong>Johannes Kepler</strong> y su
            obra <em>Harmonices Mundi</em> (1619), donde propuso que los
            movimientos planetarios siguen proporciones matemáticas armónicas —
            la música de las esferas. Sus leyes del movimiento planetario son la
            base de nuestro sistema orbital.
          </p>
          ...
          >
            Parte de su narrativa y concepto de{" "}
            <strong>red energética planetaria</strong> está influenciado por las
            ideas del investigador mexicano{" "}
            <strong>Jacobo Grinberg-Zylberbaum</strong>, especialmente su obra{" "}
            <em>La teoría sintérgica</em>.
          </p>
          ...
          >
            Estas referencias han sido reinterpretadas libremente con fines
            artísticos y narrativos.
          </p>
        ...
        >
          ...
          >
            ...
            >
              <span
                style={{ color: "#ef4444", fontSize: "20px", minWidth: "30px" }}
              >
                🖥️
              </span>
              <div>
                ...
                <span style={{ opacity: 0.9 }}>
                  {" "}
                  Intel Core i5 8va Gen o AMD Ryzen 5 2600 (o equivalentes)
                </span>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <span style={{ opacity: 0.9 }}>
                  {" "}
                  12 GB mínimo (16 GB recomendado)
                </span>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <span style={{ opacity: 0.9 }}>
                  {" "}
                  NVIDIA GTX 1050 / AMD RX 560 o superior con soporte WebGL 2.0
                </span>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <span style={{ opacity: 0.9 }}>
                  {" "}
                  Chrome 90+, Firefox 88+, Edge 90+ (con WebGL 2.0 habilitado)
                </span>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <span style={{ opacity: 0.9 }}>
                  {" "}
                  Recomendada para carga inicial de assets 3D
                </span>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <span style={{ opacity: 0.9 }}>
                  {" "}
                  1920x1080 o superior para mejor experiencia visual
                </span>
              </div>
            </div>
          </div>
          ...
          >
            <strong style={{ color: "#fbbf24" }}>⚠️ Nota:</strong> El juego
            utiliza tecnologías web avanzadas (WebGL 2.0, Web Audio API,
            WebWorkers). Para una experiencia óptima, asegúrate de tener los
            drivers de tu tarjeta gráfica actualizados y la aceleración por
        ...
        >
          ...
          >
            "Algunos antiguos sistemas sugieren que la realidad es una red
            estructurada de información. Si dicha red es alterada, el espacio y
            el tiempo podrían deformarse."
          </p>
        ...
        {[
          ...
          },
          {
            ...
            text: "Escena nocturna interactiva ambientada en el desierto de Rub' al Khali (20.0°N, 50.0°E) — uno de los cielos más despejados del planeta. Muestra 83,148 estrellas en tres capas: 80,000 estrellas procedurales de fondo galáctico, 3,000 estrellas brillantes con shader de centelleo dinámico, y 148 estrellas del catálogo Yale Bright Star con posiciones RA/Dec reales y colores espectrales. Las 27 constelaciones visibles incluyen Orión, Osa Mayor, Casiopea, Escorpión, Cruz del Sur (destacada para el hemisferio sur), Centauro, Sagitario, Pegaso, Andrómeda, Cygnus y más. La Vía Láctea se renderiza como banda galáctica procedimental con shader GLSL. La luna usa textura fotorrealista en modo billboard (siempre mira al observador). Halo atmosférico en el horizonte simula el scattering real. Controlable con WASD + Shift en PC, o D-pad táctil en mobile. Brújula astronómica integrada.",
          },
          {
            icon: "☀️",
