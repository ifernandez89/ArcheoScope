    ...
    def _check_polar_regions(self, lat: float, lon: float) -> Optional[EnvironmentContext]:
        ...
        if lat <= -60:
            ...
            return EnvironmentContext(
                ...
                primary_sensors=["ICESat-2", "Sentinel-1 SAR", "PALSAR-2"],
                secondary_sensors=["MODIS LST", "Landsat 8 Thermal"],
        ...
        if 66.5 <= lat <= 75:
            ...
            if not (-75 <= lon <= -10):
                ...
                return EnvironmentContext(
                    ...
                    elevation_m=100,
                    primary_sensors=["Sentinel-1 SAR", "Landsat 8 NDVI", "MODIS LST"],
                    secondary_sensors=["ICESat-2", "PALSAR-2"],
    ...
    def _check_mountain_glaciers(self, lat: float, lon: float) -> Optional[EnvironmentContext]:
        ...
        if 45 <= lat <= 48 and 6 <= lon <= 13:
            ...
            return EnvironmentContext(
                ...
                elevation_m=3000,
                primary_sensors=["ICESat-2", "Sentinel-1 SAR", "Landsat 8 Thermal"],
                secondary_sensors=["MODIS LST", "PALSAR-2"],
                archaeological_visibility="low",
                preservation_potential="excellent",
                access_difficulty="extreme",
    ...
    def _check_mountain_regions(self, lat: float, lon: float) -> Optional[EnvironmentContext]:
        ...
        if -12 <= lat <= -8 and -70 <= lon <= -65:
            ...
            return EnvironmentContext(
                ...
                primary_sensors=["Sentinel-2 NDVI", "Sentinel-1 SAR", "OpenTopography"],
                secondary_sensors=["Landsat 8 NDVI", "MODIS LST"],
        ...
        if -56 <= lat <= -40 and -76 <= lon <= -68:
            ...
            return EnvironmentContext(
                ...
                elevation_m=2000,
                primary_sensors=["OpenTopography", "Sentinel-2 NDVI", "Sentinel-1 SAR"],
                secondary_sensors=["Landsat 8 NDVI", "MODIS LST"],
                archaeological_visibility="medium",
                preservation_potential="excellent",
                access_difficulty="difficult",
    ...
    def _classify_by_climate(self, lat: float, lon: float) -> Optional[EnvironmentContext]:
        ...
        if 23.5 <= abs_lat < 50:
            ...
            return EnvironmentContext(
                ...
                precipitation_mm_year=800,
                elevation_m=300,
                primary_sensors=["Sentinel-2 NDVI", "Landsat 8 NDVI", "Sentinel-1 SAR"],
                secondary_sensors=["OpenTopography", "MODIS LST"],
                archaeological_visibility="medium",
                preservation_potential="moderate",
